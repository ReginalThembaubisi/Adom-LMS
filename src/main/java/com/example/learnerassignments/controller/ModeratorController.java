...
public class ModeratorController {
    ...
    private Moderator getAuthenticatedModerator(Authentication auth) {
        ...
        return moderatorRepository.findByUsername(username)
                .orElseThrow(() -> new ResourceNotFoundException("Authenticated moderator not found"));
    }

    /**
     * What this moderator is allowed to reach. A moderator with no assignment rows resolves to
