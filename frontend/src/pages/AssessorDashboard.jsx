...
const AssessorDashboard = () => {
    ...
    return (
        <div className="min-h-screen bg-slate-50 text-slate-800 flex flex-col font-sans">
            {/* Header */}
            <header className="px-6 py-4 bg-linear-to-r from-slate-900 to-indigo-950 border-b border-slate-800 flex items-center justify-between sticky top-0 z-40">
                <div className="flex items-center gap-3">
                    <div className="w-10 h-10 bg-indigo-500/10 text-indigo-300 rounded-2xl flex items-center justify-center font-extrabold text-lg shadow-sm border border-indigo-500/15">
                        A
                    </div>
                    <div>
                        <h1 className="text-base font-extrabold text-white">Assessor Marking Portal</h1>
                        <p className="text-[10px] text-slate-300 font-sans tracking-wide uppercase">Review and Grading console</p>
                    </div>
                </div>
                <button
                    ...
                    <div className="bg-white border border-slate-200 rounded-2xl p-5 space-y-4 shadow-sm">
                        ...
                        <div className="space-y-1.5">
                            ...
                            <select
                                ...
                                className="w-full bg-white border border-slate-300 rounded-xl px-3 py-2 text-xs text-slate-800 focus:outline-none focus:border-indigo-500 transition-colors"
                            >
                    ...
                    <div className="bg-white border border-slate-200 rounded-2xl p-6 h-full flex flex-col justify-between min-h-[60vh] shadow-sm">
                        <div className="space-y-6">
                            <div className="border-b border-slate-200 pb-4">
                                ...
                                <p className="text-xs text-slate-500 mt-1">Review and grade submitted documents for the selected session.</p>
                            </div>
